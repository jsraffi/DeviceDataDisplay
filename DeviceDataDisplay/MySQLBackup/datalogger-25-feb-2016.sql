...
INSERT INTO `channels` VALUES (1,'enabled','Flow analog TF','Temperature',24,10000000000000,0,0,0,0,0,1,0),(2,'enabled','Flow analog FR','pH',24,10000000000000,0,0,0,0,0,7,0),(3,'enabled','Flow pulse TF','Flow',24,10000000000000,0,0,0,0,0,4,0),(4,'enabled','Flow pulse FR','pH',24,10000000000000,0,0,0,0,0,8,0),(5,'enabled','TDS','Flow',25,10000000000000,0,0,1,1,1,2,1),(6,'enabled','Level Meter 2','Air',24,10000000000000,0,0,0,0,0,0,0),(7,'enabled','Flow analog FR','Pressure',16,10000000000000,0,0,0,0,0,0,0),(8,'enabled','Water System','Fahrenheit',19,10000000000000,0,0,0,0,0,0,0),(9,'enabled','Channel 9','Kelvin',1,10000000000000,0,0,0,0,0,0,0),(10,'enabled','Channel 10','Joule',1,10000000000000,0,0,0,0,0,0,0),(11,'enabled','Channel 11','meter',20,10000000000000,0,0,0,0,0,0,0),(12,'enabled','Channel 12','Km/hr',16,10000000000000,0,0,0,0,0,0,0),(13,'enabled','Channel 13','pH',18,10000000000000,0,0,0,0,0,0,0),(14,'enabled','Channel 14','Flow',1,10000000000000,0,0,0,0,0,0,0),(15,'enabled','Channel 15','Air',15,10000000000000,0,0,0,0,0,0,0),(16,'enabled','Channel 16','Pressure',13,10000000000000,0,0,0,0,0,0,0),(17,'enabled','Channel 17','Fahrenheit',15,10000000000000,0,0,0,0,0,0,0),(18,'enabled','Channel 18','Kelvin',18,10000000000000,0,0,0,0,0,0,0),(19,'enabled','Channel 19','Joule',1,10000000000000,0,0,0,0,0,0,0),(20,'enabled','Channel 20','meter',1,10000000000000,0,0,0,0,0,0,0),(21,'enabled','Channel 21','Km/hr',1,10000000000000,0,0,0,0,0,0,0),(22,'enabled','Channel 22','pH',1,10000000000000,0,0,0,0,0,0,0),(23,'enabled','Channel 23','Flow',1,10000000000000,0,0,0,0,0,0,0),(24,'enabled','Channel 24','Air',1,10000000000000,0,0,0,0,0,0,0),(25,'enabled','Channel 25','Pressure',1,10000000000000,0,0,0,0,0,0,0),(26,'enabled','Channel 26','Fahrenheit',1,10000000000000,0,0,0,0,0,0,0),(27,'enabled','Channel 27','Kelvin',1,10000000000000,0,0,0,0,0,0,0),(28,'enabled','Channel 28','Joule',1,10000000000000,0,0,0,0,0,0,0),(29,'enabled','Channel 29','meter',1,10000000000000,0,0,0,0,0,0,0),(30,'disabled','Channel 30','Km/hr',1,10000000000000,0,0,0,0,0,0,0),(31,'enabled','Channel 31','pH',1,10000000000000,0,0,0,0,0,0,0),(32,'disabled','Channel 32','Flow',19,10000000000000,0,0,0,0,0,0,0);
...
INSERT INTO `device_alarm` VALUES (5,2,0,'High'),(6,2,1,'Low'),(7,2,2,'High Low'),(8,2,3,'Band'),(9,2,4,'Off'),(10,1,7,'High'),(11,5,0,'Off'),(12,5,1,'Low'),(13,5,2,'High'),(14,5,3,'High-Low'),(15,5,4,'Band'),(16,6,0,'Off'),(17,6,1,'Low'),(18,6,2,'High'),(19,6,3,'High-Low'),(20,6,4,'Band');
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='Adjusting precison and scale to an exisitng value read from meter as meter can display only long integer vaue no decimal vlaue		';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `device_resolution` VALUES (2,1,0,1000),(3,1,1,100),(4,1,2,10),(5,1,3,1),(6,4,0,1000),(7,4,1,100),(8,4,2,10),(9,4,3,1),(10,16,0,100),(11,5,0,1),(12,5,1,10),(13,5,2,100),(14,5,3,1000),(15,5,4,10000),(16,6,0,1),(17,6,1,10),(18,6,2,100),(19,6,3,1000),(20,6,4,10000),(21,7,0,100),(22,7,1,10),(23,7,2,1),(24,8,0,100),(25,8,1,10),(26,8,2,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='defines units to be read devices based on index value';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `device_units` VALUES (1,1,0,'m³'),(2,1,1,'lt'),(3,1,2,'gl'),(4,1,3,'kg'),(5,4,0,'m³'),(6,4,1,'lt'),(7,4,2,'gl'),(8,4,3,'kg'),(9,7,0,'kg/sec'),(10,7,1,'kg/min'),(11,7,2,'kg/hr'),(12,8,0,'m³/sec'),(13,8,1,'m³/min'),(14,8,2,'m³/hr');
...
CREATE TABLE `devices` (
  ...
  `channel_name_address` int(11) DEFAULT NULL,
  `channel_name_length` int(11) DEFAULT NULL,
  `min_level_address` int(11) DEFAULT NULL,
  `min_level_length` int(11) DEFAULT NULL,
  `max_level_address` int(11) DEFAULT NULL,
  `max_level_length` int(11) DEFAULT NULL,
...
INSERT INTO `devices` VALUES (1,5,2,2,6,1,NULL,NULL,9,1,'Flow analog TF',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,2,0,1,NULL,NULL,1,1,NULL,NULL,'TDS device',0,9,1,NULL,NULL,3,1,2,1),(3,3,0,2,NULL,NULL,NULL,NULL,NULL,NULL,'Counter device',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,4,2,2,6,1,NULL,NULL,9,1,'Flow pulse TF',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,6,0,2,60,5,52,1,50,1,'Level Meter 1',0,NULL,NULL,57,3,4,2,6,2),(6,6,2,2,68,5,53,1,51,1,'Level Meter 2',0,NULL,NULL,65,3,8,2,10,2),(7,5,0,2,7,1,NULL,NULL,8,1,'Flow analog FR',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,4,0,2,7,1,NULL,NULL,8,1,'Flow pulse FR',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,57,101,2,7,1,NULL,NULL,NULL,NULL,'current meter',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(10,91,101,2,7,1,NULL,NULL,NULL,NULL,'power meter',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(11,140,101,2,8,1,NULL,NULL,NULL,NULL,'System meter',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(12,125,101,2,8,1,NULL,NULL,NULL,NULL,'Cooling meter',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(13,26,101,1,8,1,NULL,NULL,NULL,NULL,'Temprature meter',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(14,28,101,1,8,1,NULL,NULL,NULL,NULL,'A/c meter',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(15,77,89,2,NULL,NULL,NULL,NULL,NULL,NULL,'Air purifier',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(16,89,58,2,67,6,9,1,56,1,'Power alarm',0,15,1,77,4,66,1,78,1),(17,26,87,2,84,5,5,2,78,1,'Temp Controller',1,45,2,46,3,48,2,34,1);
...
CREATE TABLE `poll_setting` (
  ...
  `command_interval` int(11) NOT NULL,
...
INSERT INTO `poll_setting` VALUES (1,'COM9',9600,100,32000);
...
INSERT INTO `unitsofmesurement` VALUES (1,'kg'),(2,'° C'),(3,'° F'),(4,'m'),(5,'m²'),(6,'m³'),(7,'m/s²'),(8,'kg/m³'),(9,'m³/kg'),(10,'A/m²'),(11,'A/m'),(12,'km/hr'),(13,'Pa(N/m²)'),(14,'N'),(15,'J(N-M)'),(16,'W'),(17,'V'),(18,'Ω'),(19,'pH'),(20,'K'),(21,'km/sec'),(22,'meters'),(23,'millimeters'),(24,'No-Units'),(25,'PPM');
...
-- Dump completed on 2016-02-25 21:06:37
